            ...
            <div class="about-content py-lg-5 py-3">
                <div class="row">
                    <div class="col-lg-6 p-0">
                        <img src="{{ asset('../assets/img/about_banner.png') }}" alt="Gunshop" class="img-fluid">
                    </div>
                    <div class="col-lg-6 about-info">
                        <h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">About Us</h3>
                        <p class="my-xl-4 my-lg-3 my-md-4 my-3">"Gunshop" - SHOP of hunting, sporting weapons and fishing goods IN ALMATY
                            We are the only representative of well-known world brands from European manufacturers such as:<br>
                            - SAKO and TIKKA (Finland)<br>
                            - Verney-Carron (France)<br>
                            - MAKURA (Switzerland)
                        </p>
